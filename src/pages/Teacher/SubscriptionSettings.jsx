...
const SubscriptionSettings = () => {
  const { user } = useAuth();
  const { subscription, cancelSubscription, upgradePlan } = useSubscription();
  ...
  const handleUpgradeClick = () => {
    ...
    console.log('showPlanComparison set to:', true);
  };

  const handleSelectPlan = async (planTier) => {
    if (planTier === 'free') {
      // Downgrade to free - show cancel modal
    ...
    <Layout title="Subscription Settings">
      <div className="space-y-6">
        ...
        <Card
          ...
          subtitle="Upgrade or manage your subscription plan"
        >
      ...
      {console.log('Rendering modal, showPlanComparison:', showPlanComparison)}
      <Modal
        ...
        <div className="space-y-4">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-4">
              Your subscription will be cancelled and you'll be downgraded to the Free plan after a 3-day grace period.
            </p>
            <div className="bg-blue-50 rounded-lg p-4 text-left">
              <p className="text-sm text-blue-900 font-medium mb-2">What happens next:</p>
              <ul className="text-sm text-blue-800 space-y-1 list-disc list-inside">
                <li>You'll have 3 days to reconsider</li>
                <li>All your data will be retained</li>
                <li>You'll be limited to Free plan features</li>
