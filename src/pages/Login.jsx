                ...
                <div className="mb-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <button
                      ...
                      className={`py-3 px-4 rounded-lg border-2 transition-all font-medium ${loginMethod === 'email'
                    ...
                    <button
                      ...
                      className={`py-3 px-4 rounded-lg border-2 transition-all font-medium ${loginMethod === 'studentId'
                          ? 'border-blue-500 bg-blue-50 text-blue-700'
                          : 'border-gray-200 bg-white text-gray-600 hover:border-gray-300'
                        }`}
                    >
